    ...
    <div class="row">
      ...
      <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2"><i class="fa fa-pencil-square-o"></i> Details Du Tombola : <span class="Ntomb"></span></h1>
  ...
  success: function (response) {
        ...
        $.each(response.billet, function (key, value) { 
            $('.billet-list').append('<tr>'+                
                    ...
                    <td>'+value['username']+'</td>\
                    <td>\
                        <a href="billetdetail.php?id='+value['id']+'" class="btn btn-sm btn-info viewbtn"> <i class="fa fa-eye"></i> V</a>\
                    </td>\
                </tr>');
        });
         $('#exampleN').DataTable();
